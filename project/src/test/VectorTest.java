...
public class VectorTest {
	...
	public void testNormalize  () {
		Vector vec=new Vector(new Point3D(new Coordinate(0),new Coordinate(3),new Coordinate(4)));
		//Vector vec2=new Vector(new Point3D(new Coordinate(0),new Coordinate(3),new Coordinate(4)));
	//double d=vec2.length();
		//vec2.scale((double)1/d);
	vec.normalize();
	assertEquals(vec,new Vector(new Point3D(new Coordinate(0),new Coordinate((double)3/5),new Coordinate((double)4/5))));
	...
	*/
	...
	public void testCrossProduct  () {
		...
		Vector vec3=vec.crossProduct(vec2);
